...
public class CameraActivity extends Activity implements CvCameraViewListener2, OnTouchListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //camera
        cameraView = (CameraBridgeViewBase) findViewById(R.id.camera_calibration_java_surface_view);
    ...
    public void onCameraViewStarted(int width, int height) {
        ...
        if (mWidth != width || mHeight != height) {
            mWidth = width;
            mHeight = height;
            mCalibrator = new TmpCameraCalibrator(mWidth, mHeight);
            if (TmpCalibrationResult.tryLoad(this, mCalibrator.getCameraMatrix(), mCalibrator.getDistortionCoefficients())) {
                mCalibrator.setCalibrated();
            }

            frameRender = new OnCameraFrameRender(new CalibrationFrameRender(mCalibrator));
        }*/
